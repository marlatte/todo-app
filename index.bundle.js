...
function warnTaskDelete(selectedId, taskTitle, reopenDialog) {
	sweetalert__WEBPACK_IMPORTED_MODULE_2___default()({
		...
		if (willDelete) {
			...
			if (reopenDialog) {
				setTimeout(() => {
					_pubsub__WEBPACK_IMPORTED_MODULE_1__.PubSub.publish(_pubsub__WEBPACK_IMPORTED_MODULE_1__.EV.INDEX.CARD_CLICK, selectedId);
				}, 70);
			} else {
				sweetalert__WEBPACK_IMPORTED_MODULE_2___default()({
					title: "Nevermind!",
