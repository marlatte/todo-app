...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   confirmWarning: () => (/* binding */ confirmWarning)
/* harmony export */ });
function confirmWarning(question) {
	// build a warning
...
function handleTaskDelete(e) {
	...
	sweetalert__WEBPACK_IMPORTED_MODULE_9___default()({
		title: "Are you sure?",
		text: `Once deleted, the "${(0,_helpers__WEBPACK_IMPORTED_MODULE_2__.makeFirstUpper)(
			task.title
		...
		if (willDelete) {
			_pubsub__WEBPACK_IMPORTED_MODULE_0__.PubSub.publish(_pubsub__WEBPACK_IMPORTED_MODULE_0__.EV.TASK.DELETE, selectedId);
			sweetalert__WEBPACK_IMPORTED_MODULE_9___default()({
